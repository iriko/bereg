...
abstract class JModuleHelper
{
	...
	public static function renderModule($module, $attribs = array())
	{
		...
		$chromePath = JPATH_THEMES . '/' . JFactory::getApplication()->getTemplate() . '/html/modules.php';
	...
	protected static function &_load()
	{
		...
		$clientId = (int) JFactory::getApplication()->getClientId();
		...
		*/
			...
			// Filter by language
			if (JFactory::getApplication()->isSite() && $app->getLanguageFilter())
			{
