...
class JFormFieldCategoryk2 extends JFormField
{
    ...
    function getCategory()
    {
        ...
        $HTMLSelect = '<select onchange="return selectedparents(this);" name="' . $control_name . '[params][' . $name . '][]" id="' . $control_name . '_params_' . $name . '" class="inputbox" multiple="multiple" size="10">';
