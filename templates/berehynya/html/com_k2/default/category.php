...
<div id="k2Container" class="itemListView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemListCategoriesBlock">
		...
		<div class="itemListCategory">
			...
			<!-- Category title -->
			<h1 class="category-name"><?php echo $this->category->name; ?><?php if($this->params->get('catTitleItemCounter')) echo ' ('.$this->pagination->total.')'; ?></h1>
			<?php endif; ?>
		...
		<div class="itemListSubCategories">
			<h3 class="children-subcategories-name"><?php echo JText::_('K2_CHILDREN_CATEGORIES'); ?></h3>
