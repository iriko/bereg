<?php
/**
 * @version     $Id: view.json.php 1691 2012-10-05 16:06:06Z lefteris.kavadas $
 * @package     K2
...
class K2ViewItemlist extends JAK2FilterView
{
    ...
    function display($tpl = null)
    {
        ...
        $response->site->name = K2_JVERSION == '30' ? $config->get('config.sitename') : $config->getValue('config.sitename');
        ...
        if (!count($response->items) && $task == 'tag')
        {
