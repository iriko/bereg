<?php
/**
 * @version		$Id: view.html.php 1691 2012-10-05 16:06:06Z lefteris.kavadas $
 * @package		K2
...
class K2ViewItemlist extends JAK2FilterView
{
    ...
    function display($tpl = null)
    {
        ...
        $db = JFactory::getDBO();
		$jak2filterconfig = JComponentHelper::getParams('com_jak2filter');
        // Add link
        ...
        $sef = K2_JVERSION == '30' ? $config->get('config.sef') : $config->getValue('config.sef');
		...
		// JAK2Filter
		if ($jak2filterconfig->get('theme')) {
			$this->_addPath('template', JPATH_BASE.DS.'components'.DS.'com_k2'.DS.'templates'.DS.$jak2filterconfig->get('theme'));
            $this->_addPath('template', JPATH_SITE.DS.'templates'.DS.$mainframe->getTemplate().DS.'html'.DS.'com_k2'.DS.'templates'.DS.$jak2filterconfig->get('theme'));
            $this->_addPath('template', JPATH_SITE.DS.'templates'.DS.$mainframe->getTemplate().DS.'html'.DS.'com_k2'.DS.$jak2filterconfig->get('theme'));
		}
