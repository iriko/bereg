...
class VideoSource_YoutubeSearch
{
	...
	public static function getVideoIDList($youtubeURL,$optionalparameters,&$playlistid)
	{
		...
		$url = 'https://gdata.youtube.com/feeds/api/videos?category='.urlencode($keywords).'&v=2&'.$spq;
		//$url='https://gdata.youtube.com/feeds/api/videos?category=dogs%2C101%2Ccats&v=2&start-index=1&max-results=10';
		//echo '$url='.$url.'<br/>';
		//die;
