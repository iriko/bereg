	...
	function formVideoList($rawList,&$firstvideo)
	{
		...
		foreach($rawList as $b)
		{
			...
			if($vsn=='youtubeuseruploads' or $vsn=='youtubestandard' or $vsn=='youtubeplaylist' or $vsn=='youtubeuserfavorites' or $vsn=='youtubesearch' or $vsn=='vimeouservideos' or $vsn=='vimeochannel' or $vsn=='dailymotionplaylist') 
			{
				...
				{
					//echo '$theLinkItem='.$theLinkItem.'<br/>';
					//echo '$video_source='.$video_source.'<br/>';
					
					$item=$this->GrabVideoData($theLinkItem,$video_source);
					//echo 'videoid='.$item['videoid'].'<br/>';
					if($item['videoid']!='')
					{
			...
			else
			{
				...
				//echo '22222222222222222222222<br/>';
				//print_r($item);
				//die;
	...
	function GrabVideoData($listitem,$vsn,$videoid_optional='')
	{
			...
			switch($vsn)
			{
				...
				case 'dailymotion' :
					...
					//echo '2:$videoid='.$videoid.'<br/>';
					//echo '$theLink='.$theLink.'<br/>';
