...
class shSEFConfig {
  ...
  var $insertPaginationTags = true;

  var $UrlCacheHandler = 'File'; // | Sharedmemory
  var $displayUrlCacheStats = false;

  //3.6
  var $analyticsUserGroups = null;
...
unset($shDefaultParamsHelp);
    ...
    $this->content_page_name = empty($this->pageTexts[Sh404sefFactory::getPageInfo()->currentLanguageTag]) ? 'Page' : str_replace('%s', '', $this->pageTexts[Sh404sefFactory::getPageInfo()->currentLanguageTag]); // V 1.2.4.r
