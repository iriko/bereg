<?php /* Smarty version 2.6.26, created on 2013-04-09 21:42:44
...
<?php if ($this->_tpl_vars['printConfigFileStatus']): ?><div style="border: solid 1px #333;margin:5px 0 5px 0;padding:5px;text-align:left;font-weight:bold;"><?php echo @_HWDVIDS_INFO_CONFIGF1; ?>
...
" size="40" maxlength="100"></td>
    ...
    <tr>
      <td align="left" valign="top" width="20%"><b><?php echo @_HWDVIDS_PATHQTFS; ?>
</b></td>
      <td align="left" valign="top" width="20%"><input type="text" name="qtfaststart" value="<?php echo $this->_tpl_vars['s']->qtfaststart; ?>
" size="40" maxlength="100"></td>
      <td align="left" valign="top" width="60%"><?php echo @_HWDVIDS_SETT_PATHQTFS_DESC; ?>
</td>
    </tr>
  </table>
</div>
