<?php /* Smarty version 2.6.26, created on 2013-04-09 21:43:08
...
/components/com_hwdvideoshare/converters/converter_internal.php"><?php echo @_HWDVIDS_CONVERSIONSTART; ?>
            ...
            <div style="padding:5px;">
              <a href="<?php echo $this->_tpl_vars['mosConfig_live_site']; ?>
/components/com_hwdvideoshare/converters/converter.php?internal=1">         
...
</b> [<a href="index.php?option=com_hwdvideoshare&task=cancelThumbnailRegeneration" target="_top">CANCEL</a>]<br />
                  <b><?php echo @_HWDVIDS_INFO_QFDRC; ?>
: <?php echo $this->_tpl_vars['total7']; ?>
</b> [<a href="index.php?option=com_hwdvideoshare&task=cancelDurationRecalculation" target="_top">CANCEL</a>]<br />
